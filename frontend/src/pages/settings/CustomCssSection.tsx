...
export default function CustomCssSection() {
  ...
  return (
    <Section
      title="Custom CSS"
      description="Optional user stylesheet on top of the current palette."
      hidden={
        !!q &&
        !match(
          "custom css",
        ...
        <SettingRow
          ...
          control={
            <Toggle
              ...
              onChange={() =>
                update({ customCssEnabled: !settings.customCssEnabled })
              }
            />
          }
        />
        <Collapse open={settings.customCssEnabled}>
