...
export const CSS_SELECTORS: CssHookRow[] = [
  ...
  { selector: ".horde-meta-scrollbar", meaning: "Watch description/chapters, dropdown lists, and settings activity native scrollbar (hidden; overlay thumb on hover/scroll)" },
